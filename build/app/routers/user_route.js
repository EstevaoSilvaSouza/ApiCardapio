...
class UserRouter extends user_controller_1.default {
    constructor() {
        ...
        this.createUserAddStoreChange = () => this.Router.post('/create-userstore', (0, auth_checkPermission_1.CheckPermission)(['Root', 'SuperAdmin', 'Admin']), auth_httponly_1.AuhHttpOnly, this.CreateUserAddStore);
